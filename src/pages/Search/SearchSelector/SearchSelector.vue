<template>
  <div class="clearfix selector">
    ...
    <div class="type-wrap" v-for="attrs1 in attrsList" :key="attrs1.attrId">
      <div class="fl key">{{ attrs1.attrName }}</div>
      <div class="fl value">
        <ul class="type-list">
          <li v-for="(attrValue, index) in attrs1.attrValueList" :key="index">
            <a>{{ attrValue }}</a>
          </li>
        </ul>
      </div>
